...
Footer component for page bottom navigation and information.
...
## Centered with Social and Copyright
...
| `footer-title` | Title for navigation section |
| `footer-center` | Centered layout |
