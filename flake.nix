    ...
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in {
        ...
        apps = {
          ...
          flix-run             = { type = "app"; program = "${mkFlixApp "flix-run"   "flix run -- ../app/static/wec/2025/cota_6h.csv --output ../app/static/wec/2025/cota_6h.json"}/bin/flix-run"; meta.description = "Run Flix project (CSV -> JSON)"; };
        };
      });
}
