...
wec_2026 : List EventSummary
wec_2026 =
    List.map toEventSummary_Wec_2026
        [ Imola_6h
        , Spa_6h
        , LeMans_24h
        , SaoPaulo_6h
...
toEventSummary_Wec_2026 : Wec -> EventSummary
toEventSummary_Wec_2026 event =
    let
        id =
        ...
        circuit =
            Data.Series.Wec.circuit { season = 2026, event = event }
    in
    case event of
        Imola_6h ->
            { id = id
...
carImageFileName_2026 : String -> Maybe String
