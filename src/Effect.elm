...
updateRaceControl_F1 =
    Shared.Msg.RaceControlMsg_F1 >> SendSharedMsg


updateRaceControl_Wec : RaceControl.Msg -> Effect msg
updateRaceControl_Wec =
    Shared.Msg.RaceControlMsg_Wec >> SendSharedMsg
