...
mod tests {
    ...
    fn class_to_string() {
        ...
        assert_eq!(Class::HYPERCAR.to_string(), "HYPERCAR");
    ...
    fn class_from_string() {
        ...
        assert_eq!(Class::from_string("HYPERCAR"), Some(Class::HYPERCAR));
    ...
    fn class_hex_colors() {
        ...
        assert_eq!(Class::HYPERCAR.to_hex_color(2024), "#f00");
